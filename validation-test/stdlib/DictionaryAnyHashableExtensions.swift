...
DictionaryTests.test("index<Hashable>(forKey:)") {
  ...
  for (key, k, value) in [(a, 10, 1010), (b, 20, 2020), (c, 30, 3030)] {
    ...
    expectEqual(index, d.index(forKey: UInt128(k)))
    ...
    expectEqual(index, d.index(forKey: Int128(k)))
...
DictionaryTests.test("removeValue<Hashable>(forKey:)") {
  ...
  for (key, value) in [(10, 1010), (20, 2020), (30, 3030)] {
    ...
    dd = d; expectEqual(value, dd.removeValue(forKey: UInt128(key)))
    ...
    dd = d; expectEqual(value, dd.removeValue(forKey: Int128(key)))
