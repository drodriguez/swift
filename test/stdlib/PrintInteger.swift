...
PrintTests.test("Printable") {
  ...
  expectPrinted("-170141183460469231731687303715884105728", Int128.min)
  expectPrinted("170141183460469231731687303715884105727", Int128.max)
  expectPrinted("0", Int128(0))
  expectPrinted("42", Int128(42))
  expectPrinted("-42", Int128(-42))

  expectPrinted("0", UInt128.min)
  expectPrinted("340282366920938463463374607431768211455", UInt128.max)
  expectPrinted("0", UInt64(0))
  expectPrinted("42", UInt64(42))
