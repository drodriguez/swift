...
// CHECK-MODULE-MAP: PATH((.*/Inputs/custom-modules/module.map)):{{[0-9]+:[0-9]+}}: error: header 'this-header-does-not-exist.h' not found
...
// CHECK-INDIRECT: PATH((.*/Inputs/custom-modules/more-custom-modules/ImportsMissingHeaderIndirect.h)):1:9: note: while building module 'ImportsMissingHeader' imported from PATH((.*/Inputs/custom-modules/more-custom-modules/ImportsMissingHeaderIndirect.h)):1:
...
// CHECK-INDIRECT: PATH((.*/Inputs/custom-modules/more-custom-modules/ImportsMissingHeaderIndirect.h)):1:9: error: could not build module 'ImportsMissingHeader'
// CHECK-INDIRECT-NEXT: @import ImportsMissingHeader;
