...
// CHECK: --------
// CHECK: has-main: 1
// CHECK: out-file: PATH((.*/SwiftModuleA.swiftmodule))
// CHECK: DEPEND START
// CHECK: Unit | system | Swift | PATH((.*/Swift.swiftmodule))
// CHECK: DEPEND END
...
// CHECK: DEPEND START
// CHECK: Unit | system | Swift | PATH((.*/Swift.swiftmodule))
// CHECK: Unit | user | SwiftModuleA | PATH((.*/SwiftModuleA.swiftmodule))
// CHECK: DEPEND END
...
// CHECK: --------
// CHECK: has-main: 1
// CHECK: out-file: PATH((.*/s1.o))
// CHECK: DEPEND START
// CHECK: Unit | system | Swift | PATH((.*/Swift.swiftmodule))
// CHECK: Unit | user | SwiftModuleA | PATH((.*/SwiftModuleA.swiftmodule))
// CHECK: Unit | user | SwiftModuleB | PATH((.*/SwiftModuleB.swiftmodule))
// CHECK: DEPEND END

// CHECK: s2.o-
// CHECK: --------
// CHECK: has-main: 1
// CHECK: out-file: PATH((.*/s2.o))
// CHECK: DEPEND START
// CHECK: Unit | system | Swift | PATH((.*/Swift.swiftmodule))
// CHECK: Unit | user | SwiftModuleA | PATH((.*/SwiftModuleA.swiftmodule))
// CHECK: DEPEND END
