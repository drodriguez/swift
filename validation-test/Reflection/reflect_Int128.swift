...
// RUN: %target-build-swift -lswiftSwiftReflectionTest %s -o %t/reflect_Int128
// RUN: %target-codesign %t/reflect_Int128

// RUN: %target-run %target-swift-reflection-test %t/reflect_Int128 | %FileCheck %s --check-prefix=CHECK-%target-ptrsize
...
// CHECK-64: (class reflect_Int128.TestClass)
