...
//
// CHECK-COMBINED: -primary-file PATH(({{.*}}/file-01.swift)){{"?}} -primary-file PATH(({{.*}}/file-02.swift)){{"?}} PATH(({{.*}}/file-03.swift)){{"?}} PATH(({{.*}}/main.swift)){{"?}}
// NEGATIVE-CHECK-COMBINED-NOT: -primary-file PATH(({{.*}}/file-01.swift)){{"?}} -primary-file PATH(({{.*}}/file-02.swift)){{"?}} PATH(({{.*}}/file-03.swift)){{"?}} PATH(({{.*}}/main.swift)){{"?}}
