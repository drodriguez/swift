...
// CHECK-DEPS: pch-bridging-header-deps.o : {{.*}}PATH((SOURCE_DIR/test/ClangImporter/Inputs/app-bridging-header-to-pch.h)) {{.*}}PATH((SOURCE_DIR/test/ClangImporter/Inputs/chained-unit-test-bridging-header-to-pch.h))

// CHECK-SWIFTDEPS: depends-external:
// CHECK-SWIFTDEPS: - "PATH((SOURCE_DIR/test/ClangImporter/Inputs/app-bridging-header-to-pch.h))"
// CHECK-SWIFTDEPS: - "PATH((SOURCE_DIR/test/ClangImporter/Inputs/chained-unit-test-bridging-header-to-pch.h))"
